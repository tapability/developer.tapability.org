# developer.tapability.org

This is a Tapability API resource built with [nanoc][nanoc].
...
smart enough not to try to compile unchanged files:
    ...
    Compiling site...
       ...
       identical  [0.00s]  output/css/uv_active4d.css
          ...
          update  [1.31s]  output/v1/gists/comments/index.html
          update  [1.92s]  output/v1/gists/index.html
          update  [0.25s]  output/v1/issues/comments/index.html
          update  [0.99s]  output/v1/issues/labels/index.html
          update  [0.49s]  output/v1/issues/milestones/index.html
          update  [0.50s]  output/v1/issues/index.html
          update  [0.05s]  output/v1/index.html
